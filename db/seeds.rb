...
AdminUser.create(email:"admin@gmail.com",password: "123123123", password_confirmation: "123123123",first_name:"Ji",last_name:"Wang")
puts "AdminUser created #{@user.first_name}"
100.times do |post|
